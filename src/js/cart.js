...
let itemContainer = document.querySelector("#item-container>div");
let productCardBody = document.querySelector("#product-card-body");

function showEmptyCart(){
itemContainer.innerHTML = `
  <div class="row mb-2 d-flex justify-content-center text-center" id="empty-cart">
                        <div class="col-10">
                            <div class="card">
...
cardcontainer.classList.add("col-md-8", "mb-2");
